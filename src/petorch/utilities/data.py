...
from torch.utils.data import DataLoader as TorchDataLoader, Dataset as TorchDataset, default_collate, random_split
...
class DataModule(LightningDataModule, Generic[Sample_T_Co,Batch_T], ABC):
    ...
    def transfer_batch_to_device(
        self, batch: Batch_T, device: torch.device, dataloader_idx: int
    ) -> Batch_T:
